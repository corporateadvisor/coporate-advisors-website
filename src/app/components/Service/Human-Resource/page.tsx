          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              ...
              <p className="text-gray-700">
                We provide essential support services to help your business operate smoothly and remain compliant.
              </p>
              ...
              <div className="space-y-4">
                <ul className="space-y-3">
                  <li className="flex items-start font-bold font-inter text-[#575757]">
                    ...
                    <span>HR & Labour Law Compliance</span>
                  </li>
                  <li className="flex items-start font-bold font-inter text-[#575757]">
                    <span className="text-primary mr-3">•</span>
                    <span>Director & Company Secretary Training</span>
                  </li>
                  <li className="flex items-start font-bold font-inter text-[#575757]">
                    <span className="text-primary mr-3">•</span>
                    <span>Branch Registration, Re-registrations & Group Restructuring</span>
                  </li>
                  <li className="flex items-start font-bold font-inter text-[#575757]">
                    <span className="text-primary mr-3">•</span>
                    <span>Business Name Registration & Process Agent Services</span>
                  </li>
                </ul>
              </div>
            </div>
