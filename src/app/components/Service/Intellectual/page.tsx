        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-700 mb-6 max-w-2xl">
              We help businesses protect their brands, innovations, and creative assets.
            </p>

            <div className="space-y-4">
              <h3 className="font-medium text-lg text-[#1e1e1e]">Key Services Include:</h3>

              <ul className="space-y-3">
                <li className="flex items-start font-bold text-[#575757]">
                  <span className="text-[#1e1e1e] mr-3">•</span>
                  <span>Trademark & Trade Name Registration</span>
                </li>
                <li className="flex items-start font-bold text-[#575757]">
                  <span className="text-[#1e1e1e] mr-3">•</span>
                  <span>Patent Filings & Copyright Protection</span>
                </li>
                <li className="flex items-start font-bold text-[#575757]">
                  <span className="text-[#1e1e1e] mr-3">•</span>
                  <span>IP Licensing & Management</span>
                </li>
                <li className="flex items-start font-bold text-[#575757]">
                  <span className="text-[#1e1e1e] mr-3">•</span>
                  <span>Legal Enforcement of IP Rights</span>
                </li>
              </ul>
            </div>
          </div>
